...
# WEEK 2
inserito = input("Vuoi la week 2 (materiali)? (y/n) ")
if inserito == "" or inserito == "y" or inserito == "Y":
    ...
    domande.append({"domanda": "Alloy made from copper and tin", "risposta": "bronze"})
...
# WEEK 3
inserito = input("Vuoi la week 3 (componenti macchina)? (y/n) ")
if inserito == "" or inserito == "y" or inserito == "Y":
...
# WEEK 4
inserito = input("Vuoi la week 4 (lavorazione dei materiali)? (y/n) ")
if inserito == "" or inserito == "y" or inserito == "Y":
...
# WEEK 5
inserito = input("Vuoi la week 5 (disegni e schemi)? (y/n) ")
if inserito == "" or inserito == "y" or inserito == "Y":
...
# WEEK 7
inserito = input("Vuoi la week 7 (altro)? (y/n) ")
if inserito == "" or inserito == "y" or inserito == "Y":
...
correzzioni = input("Vuoi le correzioni sul momento? (y/n) ")
...
for domanda in domande:
    ...
    if inserito == domanda["risposta"]:
        giuste = giuste+1
    elif correzzioni == "" or correzzioni == "y" or correzzioni == "Y":
        print("    La risposta era: ", domanda["risposta"])
    else:
        sbagliate.append("Hai inserito '"+inserito+"' quando dovevi mettere '"+domanda["risposta"]+"'")

print()
print("Hai fatto: ",giuste, "/", length, " risposte corrette")

for sbagliato in sbagliate:
    print(sbagliato)
